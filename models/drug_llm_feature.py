...
class DRUGLLM:
    def __init__(self, device):
        self.model = AutoModelForMaskedLM.from_pretrained("/home/lyx/code/TriDTI-main/PubChem10M_SMILES_BPE_450k")
        self.tokenizer = AutoTokenizer.from_pretrained("/home/lyx/code/TriDTI-main/PubChem10M_SMILES_BPE_450k")
